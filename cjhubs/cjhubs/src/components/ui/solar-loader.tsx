  ...
  return (
    <div className="flex flex-col items-center gap-3" role="status" aria-label={label}>
      ...
      >
        ...
        />
        <circle cx="50" cy="50" r="14" className="animate-pulse-ring origin-center" fill="none" stroke="#d4af37" strokeWidth="1.5" />
        <circle cx="50" cy="50" r="13" fill="#d4af37" fillOpacity="0.18" />
        <circle cx="50" cy="50" r="9" fill="#d4af37" />
        <g className="origin-center" style={{ animation: "solar-orbit 1.8s linear infinite" }}>
          <circle cx="50" cy="14" r="4" fill="#2a4a9e" />
        </g>
      </svg>
