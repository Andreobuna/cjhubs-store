...
export const metadata: Metadata = {
  ...
  title: {
    default: "CJ Hubs Store — Find Something Special For You Or Someone You Love",
    template: "%s | CJ Hubs",
  },
  description:
  ...
  openGraph: {
    ...
    description:
      "Find something for yourself, or something special for someone else — curated gift ideas and everyday products & accessories.",
    siteName: "CJ Hubs",
    type: "website",
  },
...
const noFlashScript = `
try {
  var stored = localStorage.getItem('cjh-theme');
