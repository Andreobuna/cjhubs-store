  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6">
      ...
      <p className="mt-3 max-w-xl text-sm text-muted">
        Questions about a gift, an existing order, or a return — reach out and a real person will
        get back to you.
      </p>

      <div className="mt-10 grid gap-10 lg:grid-cols-[1fr,1.2fr]">
        <div className="space-y-5">
          <div className="flex items-center gap-3 text-sm text-muted"><Mail size={16} className="text-solar-500" /> support@cjhubs.com</div>
          <div className="flex items-center gap-3 text-sm text-muted"><Phone size={16} className="text-solar-500" /> +234 800 000 0000</div>
          <div className="flex items-center gap-3 text-sm text-muted"><MapPin size={16} className="text-solar-500" /> Lagos, Nigeria</div>
        </div>
